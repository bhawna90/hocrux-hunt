...
export const STAGES: Stage[] = [
  {
    ...
    riddleLines: [
      "I am lined with years of knowledge and dust,",
      "Where scholars come when read they must.",
      "Walk backwards through my silent hall,",
      "And find the Dark Lord's first downfall.",
    ],
    location: "Library / Bookshelf area",
  },
  {
    id: "stage-2",
    number: 2,
    ...
    riddleLines: [
      "I rest inside a vessel, patient and still,",
      "Three markers guard me — brew them, if you will.",
      "Where cold things sleep and lime meets water's pour,",
      "Complete the potion and I am yours once more.",
    ],
    location: "Kitchen / bar area — near fridge, limes, water jug, ice",
  },
  {
    id: "stage-3",
    number: 3,
    ...
    riddleLines: [
      "I wait beneath the surface, cold and still,",
      "Where only the brave reach in against their will.",
      "Drink every drop that Harry pours with care,",
      "Four digits wait below — the code is there.",
    ],
    location: "Near fridge / cold storage area — chilled water bowl + 4 labeled cups",
  },
  {
    id: "halftime",
    number: 0,
  ...
  },
  {
    ...
    keyRiddle: [
      "✏  Update this riddle in lib/stages.ts to match your venue layout.",
      "Example: I dwell not in the corners, nor on any edge that shows —",
      "third from the left, second row from your nose.",
      "Where the Badger rests in quiet — there the vault key glows.",
    ],
    clue: "The path forward is no longer yours to find alone. Seek the Hunt Master — he will direct you to your next destination.",
    riddleLines: [
      "Sixteen cups stand patient, hiding what you need,",
      "The Badger's Riddle tells you where to heed.",
      "Find the key, unlock the chest within,",
      "Then slide the tiles — and let the code begin.",
    ],
    location: "Table with 4×4 cup grid and treasure chest",
  },
  {
    id: "stage-5",
    number: 5,
    ...
    riddleLines: [
      "A board of sixty-four squares, black and white,",
      "One move alone will end the fight.",
      "Think as the Grey Lady thought — with wit,",
      "Move the piece that makes the king submit.",
    ],
    location: "Table with chess board set up",
  },
  {
    id: "stage-6",
    number: 6,
    ...
    riddleLines: [
      "I coil in darkness, hidden by slime and dread,",
      "One hand holds the sword, one drags me from my bed.",
      "Your Neville alone may touch me in the deep,",
      "Strike true with the blade and wake me from sleep.",
    ],
    location: "Table with the Horcrux sensory box and Sword of Gryffindor",
    isFinal: false,
  },
  {
    id: "stage-7",
    ...
    challenge:
      "Wait for your whole team. Choose your Harry, dress them from the box, and lead the house in the final chant.",
    challengeSteps: [
      ...
      "Once Harry is ready, they step forward and leads the whole house in the final chant: HARRY! HARRY! HARRY!",
      "When the chant is done, go to the Hunt Master and receive your final secret code. Enter it below to complete the hunt.",
    ],
    ...
    riddleLines: [
      "The final piece was never meant to be,",
      "A fragment of the Dark Lord lives in thee.",
      "Dress your Harry, mark the scar of thunder,",
      "Chant his name and tear the Dark Lord's power asunder.",
    ],
    location: "Great Hall — central / main room",
    isFinal: true,
  },
];
